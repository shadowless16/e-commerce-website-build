    ...
    <footer className="border-t border-border bg-muted mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-bold mb-4">Jumot Collections</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>Email: info@Jumot Collections.com</li>
              <li>Phone: 1-800-Jumot Collections-001</li>
            </ul>
          </div>
        </div>
        <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2026 Jumot Collections. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
